      ...
      <CardBody>
          <div className="row">
              <div className="col-lg-6">
                  ...
                  <strong className='fw-blod fs-5 text-danger'><u>Scannable Date</u></strong>
                  <div className='d-flex justify-content-between g-2 mt-4'>
                ...
                <strong className='fw-blod fs-5 text-danger'><u>Redemption Time</u></strong>
                        <div className='d-flex justify-content-between  g-2 mt-4'>
