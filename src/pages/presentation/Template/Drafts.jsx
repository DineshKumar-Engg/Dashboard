...
const Drafts = () => {
  ...
  console.log("HomeDataAutoList11", initialValues?.festivalHighlightsEvents);
                  ...
                  {({ values, handleSubmit, handleChange, touched, errors, setFieldValue, handleBlur, resetForm }) => (
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="row d-flex justify-content-center text-center mt-5">
                        ...
                        <div className="col-lg-4">
                        <div className='text-center'>
                        <Label className='h5 text-center mb-3'>Office Admin Email</Label>
                          <Popovers title='Alert !' trigger='hover' desc='Official e-mail to show on Website Footer' isDisplayInline={"true"}>
                            <Button icon='Error'></Button>
                          </Popovers>
                        </div>
