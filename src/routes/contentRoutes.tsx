...
const SINGLE = {
	...
	PASTE: lazy(() => import('../pages/presentation/single-pages/SingleBoxed')),
};

const LIST = {
	//eventPages
	CATEGORY: lazy(() => import('../pages/presentation/demo-pages/Categories')),
	LOCATION: lazy(() => import('../pages/presentation/demo-pages/Location')),
	EVENT: lazy(() => import('../pages/presentation/demo-pages/Event-Details')),
};
